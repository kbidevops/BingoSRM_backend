...
public class UserVO extends BaseVO {
    ...
    public static final String USER_TY_CODE_TEMP = "R000";
    public static final String USER_TY_CODE_MNGR = "R001";
    public static final String USER_TY_CODE_CSTMR = "R002";
    public static final String USER_TY_CODE_CHARGER = "R003";
    public static final String USER_TY_CODE_CNSLT = "R004";
    public static final String USER_TY_CODE_R005 = "R005";

    public static final String USER_STTUS_CODE_WAIT = "U001";
    public static final String USER_STTUS_CODE_ALLOW = "U002";
    public static final String USER_STTUS_CODE_STOP = "U003";
