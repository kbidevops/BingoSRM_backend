...
<%
  /**
  * @Class Name : /itsm/srvcrspons/site/edit.jsp
  ...
  <script type="text/javaScript" language="javascript" defer="defer">
    ...
    $(document).ready(function() {
      ...
      $('#requstAtchmnfl').fileupload({
        ...
        progressall: function (e, data) {
          ...
          if (progress === 100) {
            frm.action = "<c:url value="${registerFlag == 'create' ? '/itsm/srvcrspons/site/create.do' : '/itsm/srvcrspons/site/update.do'}"/>";
            frm.submit();
          }
        },
    ...
    function fncDelete() {
      confirm('삭제하시겠습니까?', 'SR요청 삭제', null, function(request) {
        ...
        if (request) {
          document.listForm.action = "<c:url value='/itsm/srvcrspons/site/delete.do'/>";
    ...
    function fncChangeRqesterNm(value) {
      ...
      if ($.trim(value) !== "") {
        ...
        $.ajax({
          type: "POST",
          url: "<c:url value='/itsm/srvcrspons/site/retrieveRqesterNmListAjax.do'/>",
          dataType: "json",
          data: {
            rqesterNm: value,
          },
    ...
    function fncChangeRqester1stNm(value) {
      ...
      if ($.trim(value) !== "") {
        ...
        $.ajax({
          type: "POST",
          url: "<c:url value='/itsm/srvcrspons/site/retrieveRqester1stNmListAjax.do'/>",
          dataType: "json",
          data: {
            rqester1stNm: value,
          },
    ...
    function fncRetrieveList() {
      ...
      document.listForm.action = "<c:url value='/itsm/srvcrspons/site/retrievePagingList.do'/>";
      </c:if>
      <c:if test="${!empty srvcRsponsFormVO.returnListMode}">
      document.listForm.action = "<c:url value='/itsm/srvcrspons/site/retrieveList.do'/>";
      </c:if>
      document.listForm.submit();
    }
