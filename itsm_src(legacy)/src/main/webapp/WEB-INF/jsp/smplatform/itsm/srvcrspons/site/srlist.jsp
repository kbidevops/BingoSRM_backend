	...
	<script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fncUpdateView(srvcRsponsNo) {
        	document.listForm.elements['srvcRsponsVO.srvcRsponsNo'].value = srvcRsponsNo;
           	document.listForm.action = "<c:url value='/srvcrspons/site/updateSrView.do'/>";
           	document.listForm.submit();
        }
        
        /* 글 등록 화면 function */
        function fncCreateView() {
           	document.listForm.action = "<c:url value='/srvcrspons/site/createSrView.do'/>";
           	document.listForm.submit();
        }
...
<!-- 									
                                    <c:if test="${srvcRsponsFormVO.srvcRsponsVO.userTyCode == 'R005' }">
	                                    <dl>
	                                        <dt>요청자ID/이름</dt>
	                                        <dd><input path="searchSrvcRsponsVO.rqesterId" class="control" title="요청자ID" /></dd>
	                                    </dl>
	                                    <dl>
	                                        <dt>요청자이름</dt>
	                                        <dd><input path="searchSrvcRsponsVO.rqesterNm" class="control" title="요청자이름" /></dd>
	                                    </dl>
									</c:if>
-->																		
<!-- 
