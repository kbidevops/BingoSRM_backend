	...
	<script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fncUpdateView(srvcRsponsNo) {
        	document.listForm.elements['srvcRsponsVO.srvcRsponsNo'].value = srvcRsponsNo;
           	document.listForm.action = "<c:url value='/srvcrspons/mngr/updateSrpView.do'/>";
...
//         	console.log('processMt: '+processMt);
        ...
        function fncReset(){
        	...
        	//document.listForm.elements['searchSrvcRsponsVO.cnfrmrId'].value = '';
...
<!-- 
                                    <dl>
                                        <dt>접수자</dt>
                                        <dd>
                                          <form:select path="searchSrvcRsponsVO.cnfrmrId" cssClass="control" title="접수자">
										  	<form:option value="">전체</form:option>
