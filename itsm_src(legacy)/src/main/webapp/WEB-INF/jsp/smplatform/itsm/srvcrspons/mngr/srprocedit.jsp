...
*/
if (document.listForm.elements['srvcRsponsVO.processDtDateDisplay'].value === '') {
    alert('처리일시를 입력하세요.');
    return;
 }
if (document.listForm.elements['srvcRsponsVO.processDtTimeDisplay'].value === '') {
    alert('처리일시를 입력하세요.');
    return;
 }
if( !$("#dataUpdtYn").is(":checked") && !$("#instlYn").is(":checked") && !$("#progrmUpdtYn").is(":checked") && !$("#infraOpertYn").is(":checked"))
{
    alert('처리방법을 선택하세요.');
    return;
}	
...
-->                
              ...
              <dl>
                ...
                <dd>
                  <div class="input-group">
                    <form:input path="srvcRsponsVO.processDtDateDisplay" id="processDtDateDisplay" class="control inpdate" title="요청일" placeholder="YYYY-MM-DD" readonly="true"/>
                    <form:input path="srvcRsponsVO.processDtTimeDisplay" id="processDtTimeDisplay" class="control inptime" title="요청시간" placeholder="HH:MM" readonly="true"/>
                  </div>
                </dd>
              </dl>
            </div>
