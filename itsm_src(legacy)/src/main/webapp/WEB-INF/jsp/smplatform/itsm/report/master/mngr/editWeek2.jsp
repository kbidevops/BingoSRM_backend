...
<head>
	...
	function fncDownload(){
		var ozrFileNm = "/knfc/weeklyReport.ozr";
	    var odiFileNm = "/knfc/weeklyReport.odi";
	...
	var procPrintList = function(ozrFileNm, odiFileNm) {
		...
		var thisweek = $("th#execDesc").html().trim();
		var nextweek = $("th#planDesc").html().trim();
	    ...
	    var ozparams = { "ozr" : ozrFileNm
	                   ...
	                   , "params" : [ 
	                	   			  ...
	                	   			  {  id: "thisWeek",	value: thisweek},
	                	   			  {  id: "nextWeek",	value: nextweek}
	                	   			]
	                   };
...
<body>
	<main id="content">
		<form:form commandName="repFormVO" id="listForm" name="listForm" method="post" enctype="multipart/form-data">
			...
			<form:hidden path="repMasterVO.repTyCode" value="B002" id="repTyCode"/>
			<form:hidden path="searchMasterVO.repTyCode" value="B002"/>
		                    ...
		                    <thead>
		                        <tr style="font-size: 11pt;" id="name1">
		                            ...
		                            <c:if test="${repDetailVO.execDesc == null ||repDetailVO.execDesc == ''}">
		                                	今週  추진실적 (${dayRange.get(0)} ~ ${dayRange.get(1)})
		                            </c:if>
		                            ...
		                            <c:if test="${repDetailVO.planDesc == null ||repDetailVO.planDesc == ''}">
		                                	次週  추진계획 (${dayRange.get(2)} ~ ${dayRange.get(3)})
		                            </c:if>
