...
<%
  /**
  * @Class Name : /srvcrspons/site/list.jsp
	...
	<script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fncUpdateView(srvcRsponsNo) {
        	document.listForm.elements['srvcRsponsVO.srvcRsponsNo'].value = srvcRsponsNo;
           	document.listForm.action = "<c:url value='/srvcrspons/site/updateSrcvView.do'/>";
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="detailbox type1">
                                    ...
                                    <dl>
                                        <dt>신청년월</dt>
                                        <dd><form:input path="searchSrvcRsponsVO.processMt" class="control" title="신청년월" placeholder="예)2023"/></dd>
                                    </dl>
                                </div>
                                <hr>
                                <div class="detailbox type1">
...
<!-- 									
                                    <c:if test="${srvcRsponsFormVO.srvcRsponsVO.userTyCode == 'R005' }">
	                                    <dl>
	                                        <dt>요청자ID/이름</dt>
	                                        <dd><form:input path="searchSrvcRsponsVO.srcRqesterId" disabled="true" class="control" title="요청자ID"/></dd>
	                                    </dl>
	                                    <dl>
	                                        <dt>요청자이름</dt>
	                                        <dd><form:input path="searchSrvcRsponsVO.srcRqesterNm" disabled="true" class="control" title="요청자이름"/></dd>
	                                    </dl>
									</c:if>									
-->
<!-- 
                                    <dl>
                                        <dt>요청자</dt>
                                        <dd>
                                          <form:select path="searchSrvcRsponsVO.rqesterId" cssClass="control" title="요청자">
										  	<form:option value="">전체</form:option>
										  	<form:options items="${srvcSRUserCodeVOList}" itemLabel="userNm" itemValue="userId"/>
										  </form:select>
                                        </dd>
                                    </dl>
-->                                    
