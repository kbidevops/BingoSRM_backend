...
*/
if (document.listForm.elements['srvcRsponsVO.finishDtDateDisplay'].value === '') {
    alert('완료일시를 입력하세요.');
    return;
 }
if (document.listForm.elements['srvcRsponsVO.finishDtTimeDisplay'].value === '') {
    alert('완료일시를 입력하세요.');
    return;
 }
      ...
      if (requstAtchmnflFileCnt > 0 && rsponsAtchmnflFileCnt > 0) {
        ...
        frm.action = "<c:url value="${registerFlag == 'create' ? '/srvcrspons/mngr/updatesrfn.do' : '/srvcrspons/mngr/updatesrfn.do'}"/>";
        frm.submit();
      }
    }
              ...
              <dl>
                ...
                <dd>
                  <div class="input-group">
                    <form:input path="srvcRsponsVO.finishDtDateDisplay" id="finishDtDateDisplay" class="control inpdate" title="완료일" placeholder="YYYY-MM-DD" readonly="true"/>
                    <form:input path="srvcRsponsVO.finishDtTimeDisplay" id="finishDtTimeDisplay" class="control inptime" title="완료시간" placeholder="HH:MM" readonly="true"/>
                  </div>
                </dd>
              </dl>
            </div>
...
-->              
            ...
            <div class="detailbox type2">
              <dl>
                <dt>완료내역</dt>
                <dd><form:textarea path="srvcRsponsVO.srvcFinDtls" class="control" title="완료내역" rows="2"></form:textarea></dd>
              </dl>
            </div>
