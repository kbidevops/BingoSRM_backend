...
public class EgovImgPaginationRenderer extends AbstractPaginationRenderer implements ServletContextAware{
	...
	*/
	public void initVariables() {
		...
		firstPageLabel = "<li class=\"d-none\"><a class=\"page-link \" href=\"#\" onclick=\"{0}({1}); return false;\">" + "<span class=\"prev\"></span></a></li>";
		previousPageLabel = "<li class=\"\"><a class=\"page-link\" href=\"#\" onclick=\"{0}({1}); return false;\">" + "<span class=\"prev\"></span></a></li>";
		currentPageLabel = "<li class=\"active\"><a class=\"page-link\" href=\"#\"><span class=\"current\">{0}</span></a></li>";
		otherPageLabel = "<li class=\"\"><a class=\"page-link\" href=\"#\" onclick=\"{0}({1}); return false;\">{2}</a>";
		nextPageLabel = "<li class=\"\"><a class=\"page-link next\" href=\"#\" onclick=\"{0}({1}); return false;\">" + "</a></li>";
		lastPageLabel = "<li class=\"d-none\"><a class=\"page-link \" href=\"#\" onclick=\"{0}({1}); return false;\">" + "<image src='" + servletContext.getContextPath() + "/images/egovframework/cmmn/btn_page_next10.gif' border=0/></a></li>";
